    ...
    <v-menu 
        ...
        <v-tabs ref="tabs" :value="selectedTab" grow icons light>
            <v-tabs-bar slot="activators">
                ...
                <v-tabs-item v-if="!isMobile" href="#timer">
                    <v-icon>access_time</v-icon>
                </v-tabs-item>
            </v-tabs-bar>
            
            <v-card  flat id="calendar">
                <v-date-picker
                        v-model="dateModel"
                        no-title
                        scrollable
       ...
       <v-tabs v-if="isMobile" ref="tabs" :value="selectedTab" grow icons light>
            <v-tabs-bar slot="activators">
...
<style>
.DateTimePicker .tabs__container.tabs__container--grow {
